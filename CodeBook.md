...
## Transformations
The Samsung training and test sets were merged to create one data set.

The features in tidyData.txt are only the mean and standard deviation reported for each measurement found in the original data. These are 66 of the original 561 features.
